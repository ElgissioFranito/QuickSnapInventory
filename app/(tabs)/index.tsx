...
export default function HomeScreen() {
  ...
  const [sortBy, setSortBy] = useState<"anarany" | "daty" | "karazany">("daty");
  ...
  if (loading) {
    return (
      <View
        ...
        className="bg-red dark:bg-gray-900"
      >
    ...
    <View style={{ flex: 1, backgroundColor: bgColor }}>
      ...
      >
        ...
        >
          ...
          <TextInput
            placeholder="Mitady inona ndray ty..."
        ...
        >
          {(["anarany", "daty", "karazany"] as const).map((option) => (
            <TouchableOpacity
              key={option}
            ...
            >
              ...
              <View style={{ flex: 1, justifyContent: "space-between" }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  ...
                  >
                    {item.lastScannedAt
                      ? `Scanné tamin'ny ${new Date(item.lastScannedAt).toLocaleDateString()}`
                      : "Tsisy mpitia"}
                  </Text>
                </View>
              </View>
      ...
      {/* Add Item Button */}
      <TouchableOpacity
        onPress={() => router.push("/add-item-modal")}
        style={{
          position: "absolute",
          bottom: 20,
          right: 20,
